...
This page lists some Frequently Asked Questions (FAQs) for the MISLAND-Africa
tool.

Installation of MISLAND-Africa
...
"MISLAND-Africa" in the list of plugins, and on "Uninstall Plugin" to uninstall 
it.
...
MISLAND-Africa uses publicly available data, as such the most up to date datasets 
...
could potentially be another limitation. MISLAND-Africa by default uses global 
